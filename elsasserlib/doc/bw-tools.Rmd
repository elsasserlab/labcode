...
They provide functionality to calculate min, max, mean, sd and coverage, but I
am not sure what the results for coverage are, so I would recommend using mean.
...
For this, you can call `multi_bw_ranges`.
